...
const Hero = () => {
  return (
    <section className="relative w-full min-h-[600px] flex items-center justify-between px-8 py-16">
      {/* Left Content */}
      <div className="flex-1 max-w-2xl z-10">
        ...
        {/* Personal Details */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8 text-sm text-gray-400">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center relative">
        ...
        <div className="relative w-[500px] h-[500px]">
          {/* Large Blob Shape */}
          <div className="absolute top-0 right-0 w-[400px] h-[400px] rounded-[40%_60%_70%_30%/40%_50%_60%_50%] border-2 border-gray-600 opacity-70"></div>
          
          {/* Medium Blob Shape */}
          <div className="absolute bottom-20 left-10 w-[300px] h-[300px] rounded-[60%_40%_30%_70%/60%_30%_70%_40%] border-2 border-gray-600 opacity-50"></div>
          
          {/* Small Blob Shape */}
          <div className="absolute top-32 left-20 w-[200px] h-[200px] rounded-[50%_50%_50%_50%/60%_40%_60%_40%] border-2 border-[var(--color-primary)] opacity-40"></div>
          
          {/* Icon Circle 1 - Top Right */}
          <div className="absolute top-16 right-16 w-16 h-16 rounded-full border-2 border-gray-600 bg-gray-800/50 backdrop-blur-sm flex items-center justify-center shadow-lg">
          ...
          <div className="absolute top-1/2 left-8 w-20 h-20 rounded-full border-2 border-[var(--color-primary)] bg-gray-800/50 backdrop-blur-sm flex items-center justify-center shadow-lg shadow-[var(--color-primary)]/20">
