        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            <SectionReveal key={project.id} delay={index * 0.1} width="100%">
              <div
                className="group relative bg-gray-800/40 backdrop-blur-sm rounded-2xl overflow-hidden border border-gray-500/50 hover:border-[var(--color-primary)] transition-all duration-300 shadow-lg shadow-gray-900/50 hover:shadow-2xl hover:shadow-[var(--color-primary)]/20 hover:-translate-y-2 h-full"
                style={{
